                ...
                <tbody>
                    @foreach ($appointment_data as $appointment)
                        <tr>
                            ...
                            <td><a href="{{ route('appointment.edit', ['id' => $appointment->id]) }}">Edit</a></td>
                            <td><a href="{{ route('appointment.delete', ['id' => $appointment->id]) }}" onclick="return confirm('Are You Sure')">Delete</a></td>
